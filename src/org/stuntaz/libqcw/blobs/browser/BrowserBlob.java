...
package org.stuntaz.libqcw.blobs.browser;
...
/**
 * Represents a Web Browser section from a workspace file. This section is
 * currently unsupported (that is, undecoded).
 * 
 * @author nall
 *
 */
public final class BrowserBlob
    extends QSection
{
    ...
    {
        return QWorkspaceSection.Browser;
    }
