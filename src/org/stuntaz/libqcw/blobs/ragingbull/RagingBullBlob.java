...
package org.stuntaz.libqcw.blobs.ragingbull;
...
/**
 * Represents a RagingBull (TM) message board section from a workspace file. This
 * section is currently unsupported (that is, undecoded).
 * 
 * @author nall
 *
 */
public final class RagingBullBlob
    extends QSection
{
    ...
    {
        return QWorkspaceSection.RagingBull;
    }

    @Override
    protected int getInternalSize()
    {
        return unknown1.getSize();
    }
