...
package org.stuntaz.libqcw.blobs.singlequote;
...
/**
 * Represents a Single Quote section from a workspace file. This section is
 * currently unsupported (that is, undecoded).
 * 
 * @author nall
 *
 */
public final class SingleQuoteBlob
    extends QSection
{
    ...
    {
        return QWorkspaceSection.SingleQuote;
    }
