...
package org.stuntaz.libqcw.blobs.tabularbar;
...
/**
 * Represents a Tabular Bar section from a workspace file. This section is
 * currently unsupported (that is, undecoded).
 * 
 * @author nall
 *
 */
public final class TabularBarBlob
    extends QSection
{
    ...
    {
        return QWorkspaceSection.TabularBar;
    }
