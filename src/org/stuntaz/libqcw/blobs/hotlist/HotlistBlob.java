...
package org.stuntaz.libqcw.blobs.hotlist;
...
/**
 * Represents a Hot List section from a workspace file. This section is
 * currently unsupported (that is, undecoded).
 * 
 * @author nall
 *
 */
public final class HotlistBlob
    extends QSection
{
    ...
    {
        return QWorkspaceSection.HotList;
    }
