...
package org.stuntaz.libqcw.blobs.islandbook;
...
/**
 * Represents an Island Book section from a workspace file. This section is
 * currently unsupported (that is, undecoded).
 * 
 * @author nall
 *
 */
public final class IslandBookBlob
    extends QSection
{
    ...
    {
        return QWorkspaceSection.IslandBook;
    }
